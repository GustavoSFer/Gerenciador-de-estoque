package com.github.gustavosfer;
...
public class Constantes {
    ...
    public static String FIM_LISTAR_FORNECEDOR = "Finalizado o fluxo de criar a lista dos fornecedores";
    public static String INICIO_BUSCAR_FORNECEDOR = "Iniciando o fluxo de buscar o fornecedor pelo id";
